...
interface CreateExerciseScreenMuscleGridStaticComponentProps {
    muscleGroups: string[];
    selectedGroup: string | null;
    onSelectGroup: (group: string) => void;
}

export default function CreateExerciseScreenMuscleGridStaticComponent({
    muscleGroups,
    selectedGroup,
    onSelectGroup,
}: CreateExerciseScreenMuscleGridStaticComponentProps): React.JSX.Element {
    return (
